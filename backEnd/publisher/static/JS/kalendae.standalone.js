...
Kalendae.prototype = {
	defaults : {
		...
		titleFormat           :'YYYY年 MMM',    /* format mask for month titles. See momentjs.com for rules */
	...
	makeSelectedDateVisible: function (date) {
		...
		outOfViewMonth = moment(date).date("1").diff(this.viewStartDate,'months',true);
		if(outOfViewMonth < -1){
			this.viewStartDate.subtract('months',1);
		}
		else if(outOfViewMonth > 0 && outOfViewMonth+1 >= this.settings.months){
...
(function (undefined) {
    ...
    ************************************/
    ...
    Language.prototype = {
        ...
        _months_cn: "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),
        months : function (m) {
            return this._months_cn[m.month()];
        },

        _monthsShort : "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),
        _monthsShort_cn: "1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),
        monthsShort : function (m) {
            return this._monthsShort_cn[m.month()];
        },
        ...
        _weekdaysMin_cn : "日_一_二_三_四_五_六".split("_"),
        weekdaysMin : function (m) {
            return this._weekdaysMin_cn[m.day()];
        },
